        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_Users_UserPhoneNumber",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteCars_Users_UserPhoneNumber",
                        column: x => x.UserPhoneNumber,
                        principalTable: "Users",
                        principalColumn: "PhoneNumber",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rentals_Users_UserPhoneNumber",
                        column: x => x.UserPhoneNumber,
                        principalTable: "Users",
                        principalColumn: "PhoneNumber",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCars_UserPhoneNumber",
                table: "FavoriteCars",
                column: "UserPhoneNumber");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_UserPhoneNumber",
                table: "Messages",
                column: "UserPhoneNumber");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_UserPhoneNumber",
                table: "Rentals",
                column: "UserPhoneNumber");
        }
